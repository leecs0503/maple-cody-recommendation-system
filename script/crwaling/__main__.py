...
def main():
    ...
    parser.add_argument("--json_name_1", type=str, help="merge 할 json 파일_1 지정")
    parser.add_argument("--json_name_2", type=str, help="merge 할 json 파일_2 지정")
    ...
    if args.json_merge:
        json_merge(args.json_name_1, args.json_name_2)
